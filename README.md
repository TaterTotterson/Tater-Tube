...
- Server-backed Newsgroups browsing and streaming through The Tube
...
### The Tube
- Connects to Tater Tube Server for Newznab-backed streaming
- Newznab URL, API key, provider username, and browse limit are configured on Tater Tube Server
...
- Includes Newsgroups search from The Tube menu
- Supports larger browse limits of 50, 100, 250, or 500 results
- Streams selected releases through the server-managed Usenet pipeline
- Supports provider-backed trending for movies and TV
- Trending views include today, week, month, and year
- The player only needs the Tater Tube Server URL and a pairing PIN generated by the server
